        ...
        <div class="header-body">
            ...
            <nav class="navbar navbar-horizontal navbar-expand-lg navbar-dark bg-default">
                <div class="container" style="max-width:100%">
                    <a class="navbar-brand" href="#">Admin Tables</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-dot mr-4">
                                        <i class="{{ $admin->getStatus() ? 'bg-success' : 'bg-warning' }}"></i>{{ $admin->getStatus() ? 'On' : 'Off' }}
                                    </span>
                                </td>
                                <td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <a class="dropdown-item" href="{{ route('dashboard.admin::edit',$admin) }}">Edit</a>
